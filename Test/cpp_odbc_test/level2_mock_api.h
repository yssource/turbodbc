...
namespace cpp_odbc_test {
	...
	struct level2_mock_api : public cpp_odbc::level2::api {
		...
		MOCK_CONST_METHOD3(do_set_environment_attribute, void(cpp_odbc::level2::environment_handle const &, SQLINTEGER, long));
		MOCK_CONST_METHOD3(do_set_connection_attribute, void(cpp_odbc::level2::connection_handle const &, SQLINTEGER, long));
		...
		MOCK_CONST_METHOD1(do_row_count, SQLLEN(cpp_odbc::level2::statement_handle const & handle));
	};
