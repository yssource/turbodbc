...
public:
	...
	void add_parameter_set(pybind11::object const & parameter_set);
...
private:
	void check_parameter_set(pybind11::object const & parameter_set) const;
	void add_parameter(std::size_t index, pybind11::object const & value);
